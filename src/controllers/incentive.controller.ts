...
import Incentive from "../models/incentive/incentive";

// Get incentives from a user by user id
// GET users/:userId/incentive
const getIncentive = async (req: Request, res: Response) => {
  try {
    ...
    if (!incentive) {
      const incentive = new Incentive({user_id: user_id})
...
const updateIncentive = async (req: Request, res: Response) => {
  try {
...
const withdrawIncentive = async (req: Request, res: Response) => {
  try {
...
export {getIncentive, updateIncentive, withdrawIncentive}
